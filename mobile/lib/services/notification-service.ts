...
// 1. Safe lazy loader for expo-notifications
// Completely wrapped in try-catch so requiring never crashes or freezes Expo Go
let cachedNotifications: any = undefined;
...
export async function setupAndroidNotificationChannels() {
  ...
  if (notifs.setNotificationHandler) {
    try {
